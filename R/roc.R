...
#' 
#' @param roc_obj Object generated by roc_obj()
#' @param thresh_pos Character vector specifying whether the plot should place Youden's criterion above or below its point on the curve. Valid options include "top" or "bottom". Defaults to "top."
#' @param thresh_size Numeric specifying the font size for Youden's criterion. Defaults to 7.
#' @return A ggplot object
plot_roc <- function(roc_obj, thresh_pos="top", thresh_size=7) {
